...
using SelectGroupInListView.Module.BusinessObjects;

namespace SelectGroupInListView.Module.Web.Controllers
{
    public class SelectGroupInListViewController : ViewController
    {
        ...
        /// </summary>
        public const string gridId = "DomainObjectListViewGrid";
        ...
        protected bool GetChecked(int visibleIndex)
        {
            for (int childIndex = 0; childIndex < Grid.GetChildRowCount(visibleIndex); childIndex++)
            {
                ...
                var key = (Grid.GetChildRow(visibleIndex, childIndex) as DomainObject1).Oid;
